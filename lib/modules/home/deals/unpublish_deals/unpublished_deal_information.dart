...
class UnpublishedDealsInformation extends StatefulWidget {
  const UnpublishedDealsInformation({super.key});

  @override
  State<UnpublishedDealsInformation> createState() =>
      _UnpublishedDealsInformationState();
}

class _UnpublishedDealsInformationState
    extends State<UnpublishedDealsInformation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          LocalStrings.unpublishedDealInfo,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RoundButton(
                        ...
                        text: LocalStrings.publishDealNowButtonText,
                        onPressedFunction: () {}),
                    SizedBox(
